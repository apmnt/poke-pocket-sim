...
ATTACKS = {'absorb': {'damage': 40,
 ...
 'bone-beatdown': {'damage': 40,
                   'energy': {'fighting': 1},
                   'has_side_effect': False},
 'bonemerang': {'damage': 80,
                'energy': {'fighting': 2},
                'has_side_effect': True},
 'bother': {'damage': 50, 'energy': {'psychic': 1}, 'has_side_effect': True},
 'bubble-drain': {'damage': 60,
                  'energy': {'colorless': 2, 'water': 1},
                  'has_side_effect': True},
 'bug-bite': {'damage': 30,
              'energy': {'colorless': 2},
              'has_side_effect': False},
 'call-for-family': {'damage': 0,
                     'energy': {'darkness': 1},
                     'has_side_effect': True},
 'circle-circuit': {'damage': 30,
                    'energy': {'lightning': 2},
                    'has_side_effect': True},
 'combustion': {'damage': 30, 'energy': {'fire': 1}, 'has_side_effect': False},
 'continuous-lick': {'damage': 60,
                     'energy': {'colorless': 3},
                     'has_side_effect': True},
 'copy-anything': {'damage': 0,
                   'energy': {'colorless': 1},
                   'has_side_effect': True},
 'corner': {'damage': 60,
 ...
 'pin-missile': {'damage': 40,
                 'energy': {'colorless': 1, 'lightning': 1},
                 'has_side_effect': True},
 'poison-gas': {'damage': 10,
                'energy': {'darkness': 1},
                'has_side_effect': True},
 'poison-horn': {'damage': 90,
                 'energy': {'colorless': 1, 'darkness': 2},
                 'has_side_effect': True},
 'poison-powder': {'damage': 30,
                   'energy': {'grass': 1},
                   'has_side_effect': True},
 'poison-tentacles': {'damage': 50,
                      'energy': {'colorless': 1, 'water': 1},
                      'has_side_effect': True},
 'pound': {'damage': 20, 'energy': {'colorless': 1}, 'has_side_effect': False},
 'powder-snow': {'damage': 40,
                 'energy': {'colorless': 1, 'water': 1},
                 'has_side_effect': True},
 'power-blast': {'damage': 120,
                 'energy': {'colorless': 2, 'psychic': 2},
                 'has_side_effect': True},
 'primal-wingbeat': {'damage': 0,
                     'energy': {'colorless': 2},
                     'has_side_effect': True},
 'psy-report': {'damage': 20,
                'energy': {'psychic': 1},
                'has_side_effect': True},
 'psychic': {'damage': 30,
             'energy': {'colorless': 1, 'psychic': 1},
             'has_side_effect': True},
 'psychic-sphere': {'damage': 50,
                    'energy': {'colorless': 1, 'psychic': 1},
                    'has_side_effect': False},
 'psydrive': {'damage': 150,
              'energy': {'colorless': 2, 'psychic': 2},
 ...
 'psyshot': {'damage': 60,
             'energy': {'colorless': 1, 'psychic': 2},
             'has_side_effect': False},
 'quick-attack': {'damage': 40,
                  'energy': {'colorless': 2},
                  'has_side_effect': True},
 'raging-thunder': {'damage': 100,
                    'energy': {'colorless': 1, 'lightning': 2},
                    'has_side_effect': True},
 'rain-splash': {'damage': 30,
                 'energy': {'water': 1},
                 'has_side_effect': False},
 ...
 'razor-fin': {'damage': 10,
               'energy': {'colorless': 1},
               'has_side_effect': False},
 'razor-leaf': {'damage': 70,
                'energy': {'colorless': 2, 'grass': 1},
                'has_side_effect': False},
 'reckless-charge': {'damage': 30,
                     'energy': {'fighting': 1},
                     'has_side_effect': True},
 'rolling-tackle': {'damage': 80,
                    'energy': {'colorless': 3},
                    'has_side_effect': False},
 'rollout': {'damage': 70,
 ...
 'scratch': {'damage': 30,
             'energy': {'colorless': 1, 'grass': 1},
             'has_side_effect': False},
 'second-strike': {'damage': 10,
                   'energy': {'colorless': 1, 'water': 1},
                   'has_side_effect': True},
 'seed-bomb': {'damage': 20, 'energy': {'grass': 1}, 'has_side_effect': False},
 'seismic-toss': {'damage': 100,
                  'energy': {'fighting': 3},
                  'has_side_effect': False},
 'shadow-claw': {'damage': 40,
                 'energy': {'colorless': 2},
                 'has_side_effect': True},
 'sharp-scythe': {'damage': 30,
                  'energy': {'grass': 1},
                  'has_side_effect': False},
 'sharp-sting': {'damage': 70,
                 'energy': {'grass': 1},
                 'has_side_effect': False},
 'sharpen': {'damage': 20,
             'energy': {'colorless': 1},
             'has_side_effect': False},
 'shell-attack': {'damage': 40,
                  'energy': {'fighting': 1},
                  'has_side_effect': False},
 'sing': {'damage': 0, 'energy': {'colorless': 1}, 'has_side_effect': True},
 'sky-attack': {'damage': 130,
                'energy': {'colorless': 2, 'fire': 1},
                'has_side_effect': True},
 ...
 'strength': {'damage': 50,
              'energy': {'fighting': 2},
              'has_side_effect': False},
 'stretch-kick': {'damage': 0,
                  'energy': {'fighting': 1},
                  'has_side_effect': True},
 'suffocating-gas': {'damage': 20,
                     'energy': {'psychic': 1},
                     'has_side_effect': False},
 'super-psy-bolt': {'damage': 60,
                    'energy': {'colorless': 2, 'psychic': 1},
                    'has_side_effect': False},
 'surf': {'damage': 90, 'energy': {'water': 3}, 'has_side_effect': False},
 'surprise-attack': {'damage': 40,
                     'energy': {'colorless': 1},
                     'has_side_effect': True},
 'tackle': {'damage': 20, 'energy': {'grass': 1}, 'has_side_effect': False},
 'tail-smack': {'damage': 20,
                'energy': {'colorless': 1},
                'has_side_effect': False},
 'tail-whap': {'damage': 20,
               'energy': {'lightning': 1},
 ...
 'thunder-fang': {'damage': 80,
                  'energy': {'colorless': 1, 'lightning': 2},
                  'has_side_effect': True},
 'thunder-punch': {'damage': 40,
                   'energy': {'lightning': 2},
                   'has_side_effect': True},
 'thunder-shock': {'damage': 30,
                   'energy': {'lightning': 2},
                   'has_side_effect': True},
 'thunder-spear': {'damage': 0,
                   'energy': {'lightning': 1},
                   'has_side_effect': True},
 'thunderbolt': {'damage': 140,
                 'energy': {'lightning': 3},
                 'has_side_effect': True},
 'thundering-hurricane': {'damage': 50,
                          'energy': {'lightning': 3},
                          'has_side_effect': True},
 'tiny-charge': {'damage': 30,
                 'energy': {'lightning': 1},
                 'has_side_effect': False},
 'tongue-slap': {'damage': 20,
                 'energy': {'water': 1},
                 'has_side_effect': False},
 'tropical-swing': {'damage': 40,
                    'energy': {'grass': 1},
                    'has_side_effect': True},
 'venoshock': {'damage': 70,
               'energy': {'colorless': 1, 'darkness': 2},
 ...
 'water-drip': {'damage': 30,
                'energy': {'colorless': 1},
                'has_side_effect': False},
 'water-gun': {'damage': 40, 'energy': {'water': 1}, 'has_side_effect': False},
 'wave-splash': {'damage': 40,
                 'energy': {'colorless': 1, 'water': 1},
                 'has_side_effect': False},
 'will-o-wisp': {'damage': 30,
                 'energy': {'psychic': 1},
                 'has_side_effect': False},
 'wing-attack': {'damage': 70,
                 'energy': {'colorless': 3},
                 'has_side_effect': False},
 'zap-kick': {'damage': 20,
              'energy': {'lightning': 1},
